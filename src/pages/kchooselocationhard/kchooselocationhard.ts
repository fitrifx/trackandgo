...
/**
 * Generated class for the KchooselocationhardPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-kchooselocationhard',
  templateUrl: 'kchooselocationhard.html',
})
export class KchooselocationhardPage {
  ...
  load() : void
   {
      ...
      this.http
      .get('http://trackandgo.000webhostapp.com/klocationhard.php')
      .subscribe((data : any) =>
      {
         console.dir(data);
         this.items = data;
