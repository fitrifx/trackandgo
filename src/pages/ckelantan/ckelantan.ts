...
@IonicPage()
@Component({
  selector: 'page-ckelantan',
  templateUrl: 'ckelantan.html',
})
export class CkelantanPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad CkelantanPage');
  }
ionViewWillEnter() : void
   ...
   load() : void
   {
      ...
      this.http
      .get('http://trackandgo.000webhostapp.com/calllocationkelantan.php')
      .subscribe((data : any) =>
      {
         console.dir(data);
         this.items = data;
