...
@IonicPage()
@Component({
  selector: 'page-cchooselocationmedium',
  templateUrl: 'cchooselocationmedium.html',
})
export class CchooselocationmediumPage {
/**
    * @name items
    * @type {Array}
    * @public
  ...
  ionViewWillEnter() : void
   ...
   load() : void
   {
      ...
      this.http
      .get('http://trackandgo.000webhostapp.com/clocationmedium.php')
      .subscribe((data : any) =>
      {
         console.dir(data);
         this.items = data;
