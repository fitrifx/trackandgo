...
@IonicPage()
@Component({
  selector: 'page-kchooselocationmedium',
  templateUrl: 'kchooselocationmedium.html',
})
export class KchooselocationmediumPage {
  ...
  load() : void
   {
      ...
      this.http
      .get('http://trackandgo.000webhostapp.com/klocationmedium.php')
      .subscribe((data : any) =>
      {
         console.dir(data);
         this.items = data;
