...
/**
 * Generated class for the LocationFamilyHikingPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-location-family-hiking',
  templateUrl: 'location-family-hiking.html',
})
export class LocationFamilyHikingPage {
/**
    * @name items
    * @type {Array}
    * @public
  ...
  ionViewWillEnter() : void
   ...
   load() : void
   {
      ...
      this.http
      .get('http://trackandgo.000webhostapp.com/familylocationhiking.php')
      .subscribe((data : any) =>
      {
         console.dir(data);
         this.items = data;
