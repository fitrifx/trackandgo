...
/**
 * Generated class for the LocationIndiCavingPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-location-indi-caving',
  templateUrl: 'location-indi-caving.html',
})
export class LocationIndiCavingPage {
  ...
  ionViewWillEnter() : void
   ...
   load() : void
   {
      ...
      this.http
      .get('http://trackandgo.000webhostapp.com/indilocationcaving.php')
      .subscribe((data : any) =>
      {
         console.dir(data);
         this.items = data;
