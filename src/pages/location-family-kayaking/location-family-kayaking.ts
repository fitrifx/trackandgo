...
/**
 * Generated class for the LocationFamilyKayakingPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-location-family-kayaking',
  templateUrl: 'location-family-kayaking.html',
})
export class LocationFamilyKayakingPage {
  ...
  ionViewWillEnter() : void
   ...
   load() : void
   {
      ...
      this.http
      .get('http://trackandgo.000webhostapp.com/familylocationkayaking.php')
      .subscribe((data : any) =>
      {
         console.dir(data);
         this.items = data;
