...
/**
/**
 * Generated class for the LocationIndiKayakingPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-location-indi-kayaking',
  templateUrl: 'location-indi-kayaking.html',
})
export class LocationIndiKayakingPage {
  ...
  ionViewWillEnter() : void
   ...
   load() : void
   {
      ...
      this.http
      .get('http://trackandgo.000webhostapp.com/indilocationkayaking.php')
      .subscribe((data : any) =>
      {
         console.dir(data);
         this.items = data;
