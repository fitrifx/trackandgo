...
@IonicPage()
@Component({
  selector: 'page-cpahang',
  templateUrl: 'cpahang.html',
})
export class CpahangPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad CpahangPage');
  }
ionViewWillEnter() : void
   ...
   load() : void
   {
      ...
      this.http
      .get('http://trackandgo.000webhostapp.com/calllocationpahang.php')
      .subscribe((data : any) =>
      {
         console.dir(data);
         this.items = data;
