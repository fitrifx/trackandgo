...
/**
 * Generated class for the LocationIndiHikingPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-location-indi-hiking',
  templateUrl: 'location-indi-hiking.html',
})
export class LocationIndiHikingPage {
  ...
  ionViewWillEnter() : void
   ...
   load() : void
   {
      ...
      this.http
      .get('http://trackandgo.000webhostapp.com/indilocationhiking.php')
      .subscribe((data : any) =>
      {
         console.dir(data);
         this.items = data;
