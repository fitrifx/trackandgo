...
@IonicPage()
@Component({
  selector: 'page-cchooselocationeasy',
  templateUrl: 'cchooselocationeasy.html',
})
export class CchooselocationeasyPage {
/**
    * @name items
    * @type {Array}
    * @public
  ...
  ionViewWillEnter() : void
   ...
   load() : void
   {
      ...
      this.http
      .get('http://trackandgo.000webhostapp.com/clocationeasy.php')
      .subscribe((data : any) =>
      {
         console.dir(data);
         this.items = data;
