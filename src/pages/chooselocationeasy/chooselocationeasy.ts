...
@IonicPage()
@Component({
  selector: 'page-chooselocationeasy',
  templateUrl: 'chooselocationeasy.html',
})
export class ChooselocationeasyPage {
/**
    * @name items
    * @type {Array}
    * @public
  ...
  ionViewWillEnter() : void
   ...
   load() : void
   {
      ...
      this.http
      .get('http://trackandgo.000webhostapp.com/locationeasy.php')
      .subscribe((data : any) =>
      {
         console.dir(data);
         this.items = data;
