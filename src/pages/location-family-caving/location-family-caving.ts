...
/**
 * Generated class for the LocationFamilyCavingPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-location-family-caving',
  templateUrl: 'location-family-caving.html',
})
export class LocationFamilyCavingPage {
  ...
  ionViewWillEnter() : void
   ...
   load() : void
   {
      ...
      this.http
      .get('http://trackandgo.000webhostapp.com/familylocationcaving.php')
      .subscribe((data : any) =>
      {
         console.dir(data);
         this.items = data;
