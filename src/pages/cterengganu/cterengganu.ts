...
/**
 * Generated class for the KelantanPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-cterengganu',
  templateUrl: 'cterengganu.html',
})
export class CterengganuPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad CterengganuPage');
  }
ionViewWillEnter() : void
   ...
   load() : void
   {
      ...
      this.http
      .get('http://trackandgo.000webhostapp.com/calllocationterengganu.php')
      .subscribe((data : any) =>
      {
         console.dir(data);
         this.items = data;
